...
######################## CO_2016_01_12 ################################################
print(" ########################################## ")
print(" Data Extraction for CO_2016_01_12 - STARTED  ")
Process_Log_status_Message= " Data Extraction for CO_2016_01_12 - STARTED  "

# outfile
outfile = open('C:/Users/Deependra/Som_Data_New/Som_Data_CO_2016_01_12.txt', 'w')
...
WHEN Offer LIKE 'FD.%' THEN  'Third Class' 
ELSE NULL
 END as MailType,FIRSTNAME,LASTNAME from DBO.Freedom_TBE_Current where  STML_FULLDOC='FULLDOC' and Offer NOT LIKE 'FD[_]%%' and (Datemailed like '2017-01%%' or Datemailed like '2017-02%%') ;""")
