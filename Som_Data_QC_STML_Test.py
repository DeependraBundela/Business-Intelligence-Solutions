...
writer = pd.ExcelWriter("C:\\Deep\\Python\\Project_Som_Data\\QC_Result\\Som_Data_QC_Result_STML.xlsx", engine='xlsxwriter')
...
if QC_Check_Counter == 1:
     ...
     text_file = open("C:\\Deep\\Python\\Project_Som_Data\\QC_Result\\Error_Log.txt", "w")
